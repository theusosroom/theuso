      ...
      <section className="w-full bg-white">
        <div className="container mx-auto px-4 py-20 flex flex-col items-center text-center space-y-6">
          ...
          <div className="relative h-40 w-40 overflow-hidden rounded-full shadow-xl border-4 border-white bg-slate-200">
            <Image
              src="https://via.placeholder.com/400x400?text=Theuso" 
          ...
          <div className="flex items-center justify-center gap-5 pt-4">
            <a href="#" target="_blank" className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-100 text-slate-600 transition-all hover:bg-[#5865F2] hover:text-white hover:scale-110" aria-label="Discord">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentcolor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
            </a>
            <a href="#" target="_blank" className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-100 text-slate-600 transition-all hover:bg-[#FF424D] hover:text-white hover:scale-110" aria-label="Patreon">
            ...
            <a href="#" target="_blank" className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-100 text-slate-600 transition-all hover:bg-red-600 hover:text-white hover:scale-110" aria-label="YouTube">
