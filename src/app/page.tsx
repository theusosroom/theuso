      ...
      <section className="w-full bg-white">
        <div className="container mx-auto px-4 py-20 flex flex-col items-center text-center space-y-6">
          ...
          <div className="flex items-center justify-center gap-5 pt-4">
            <a href="https://x.com/theusosroom" target="_blank" className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-100 text-slate-600 transition-all hover:bg-[#5865F2] hover:text-white hover:scale-110" aria-label="Twitter">
            ...
            <a href="https://theusosroomcc.tumblr.com" target="_blank" className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-100 text-slate-600 transition-all hover:bg-[#4B3688] hover:text-white hover:scale-110" aria-label="Tumblr">
            <svg width="20px" height="20px" viewBox="-5 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2"><path d="m12.634 19.166 1.154 3.418c-.418.457-.962.791-1.578.947l-.022.005c-.758.28-1.634.448-2.547.462h-.006c-.077.003-.168.004-.259.004-.888 0-1.744-.139-2.548-.396l.059.016c-.788-.241-1.472-.606-2.068-1.077l.013.01c-.531-.436-.984-.94-1.355-1.504l-.016-.025c-.335-.497-.609-1.072-.789-1.687l-.011-.044c-.149-.509-.237-1.094-.24-1.7v-7.847h-2.422v-3.101c.711-.256 1.327-.595 1.878-1.015l-.017.012c.502-.374.935-.801 1.301-1.282l.012-.016c.313-.425.592-.908.817-1.42l.019-.049c.186-.401.353-.877.478-1.37l.012-.058c.085-.35.161-.785.211-1.229l.005-.051c.009-.048.032-.09.065-.122.027-.03.065-.048.108-.05h3.52v6.115h4.8v3.634h-4.817v7.47.025c0 .278.034.548.099.806l-.005-.023c.076.287.188.539.332.768l-.007-.012c.171.267.415.474.703.595l.01.004c.307.13.663.205 1.037.205.049 0 .097-.001.145-.004h-.007c.701-.001 1.366-.155 1.964-.43l-.029.012z"/></svg>
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-slate-300 py-20 flex-1">
        <div className="container mx-auto px-4">
          <header className="mb-10 flex items-center justify-between">
            <h3 className="text-3xl font-bold text-slate-900">Conteúdos em Destaque</h3>
